                ...
                <Table>
                        ...
                        <TableRow>
                            {isDeleteMode && (
                                <TableHead className="w-12">
                                    <Checkbox
                                        checked={selectedIds.length === initialPlayers.length && initialPlayers.length > 0}
                    ...
                    <TableBody>
                        ...
                        {initialPlayers.length === 0 && (
                            <TableRow>
                                <TableCell colSpan={isDeleteMode ? 4 : 3} className="text-center py-8 text-muted-foreground">
                                    No players found.
                                </TableCell>
                            </TableRow>
                        )}
            ...
            <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This action cannot be undone. This will permanently delete {selectedIds.length} selected player(s).
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
